...
try:
        ...
        os.system('pip install futures==2 && python XP_ALI01.py')
...
{50*"-"}
    Tool Version :     0.1
    OWNER  :     BILAL AHMED SHEIKH
    FACEBOOK  : TRICKER MR BILAL
    WHATS APP: +923190857715
    GITHUB  :        BILAL787000
{50*"-"}'''
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get('https://raw.githubusercontent.com/XIDI-XP/Approval/main/Approval.txt').text
                if str("upppdate") in update:
                        ...
                        print(50*"-")
                        print(f" Note : Tool is free, if you want approve so copy the key and send me on Facebook ")
                        print("\n ye tool free he agr apko access chaiye to key copy krke mujhe Facebook le baije ")
                        print(50*"-")
                        print(f" Copy the key")
                        print(f" send me on Facebook")
                        print(50*"-")
                        input("[Press Enter To Send Key To Admin]")
                        os.system(f"termux-open-url https://www.facebook.com/profile.php?id=100010399241489={bumper}")
                        qsbuy()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/XIDI' in datar:
        pass
else:
        for i in range(5000):
                print(" data is forked / or in other file")
        exit("Type > cd ~ && python XP_ALI01.py")
